...
public class SearchActivityTest {
    ...
    public void searchActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.exhibit), withText("gorilla"),
                        withParent(withParent(withId(R.id.search_recycler))),
                        isDisplayed()));
        textView.check(matches(withText("gorilla")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.exhibit), withText("siamang"),
                        withParent(withParent(withId(R.id.search_recycler))),
                        isDisplayed()));
        textView2.check(matches(withText("siamang")));
    }
